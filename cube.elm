...
face rawColor a b c d =
    let
        ...
        vertex position color =
            Vertex (makeColor color) position
    in
        [ ( vertex a rawColor, vertex b rawColor, vertex c rawColor )
        , ( vertex c (Color.complement rawColor), vertex d (Color.complement rawColor), vertex a (Color.complement rawColor) )
        ]
